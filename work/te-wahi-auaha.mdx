...
<Banner
  variant="info"
  title="In progress"
  message="This content is still being written. In the meantime, refer to the Te Wāhi website to find out more about the tools we used. "
  linkName="Te Wāhi"
  linkUrl="https://tewahi.com"
/>
